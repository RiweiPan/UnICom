...
struct file_operations {
	...
	int (*mmap_swiftcore) (struct file *, struct vm_area_struct *); //swiftcore mmap called during open
	int (*mmap_swiftcore_expose_tables) (struct file *, struct vm_area_struct *); //swiftcore helper function that maps the file table pages to enable 
																					//fast user-space IO for PoC 
																					//-- because we do not have the IOMMU extensions that would do translations in HW
	void (*swiftcore_drop_pt) (struct file *);
#endif
...
struct inode_operations {
	...
	int (*nap_mapping_lookup)(struct inode *inode, u64 lba, u64 len, u64 *pba);
#endif
