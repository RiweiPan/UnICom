...
#define VM_SWIFTCORE	BIT(VM_HIGH_ARCH_BIT_5)// marks a VMA that maps a file through swiftcore -- access to these VAs will trigger IO to access the file in storage
#define VM_HIGH_ARCH_BIT_6	38	/* bit only usable on 64-bit architectures */
#define VM_SWIFTCORE_EXPOSE	BIT(VM_HIGH_ARCH_BIT_6)// marks a helper VMA that maps the file table pages only for the PoC
#define VM_HIGH_ARCH_BIT_7	39	/* bit only usable on 64-bit architectures */
#define VM_SWIFTCORE_EXPOSE_ADDRESS_SPACE	BIT(VM_HIGH_ARCH_BIT_7)
#define VM_HIGH_ARCH_BIT_8	40	/* bit only usable on 64-bit architectures */
#define VM_SWIFTCORE_BUFFER_TO_EXPOSE	BIT(VM_HIGH_ARCH_BIT_8)
#endif
...
extern unsigned long mmap_region(struct file *file, unsigned long addr,
	...
	struct list_head *uf);
#ifdef CONFIG_SWIFTCORE_SUPPORT
extern int do_mmap_swiftcore(struct file *file,	unsigned long long len, unsigned long prot, bool expose, unsigned long *vaddr);
#endif
