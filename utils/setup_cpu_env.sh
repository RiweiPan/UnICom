...
### The Nap CPU settings follow the settings of previous papers: Cinterrupts[OSDI'21], XRP [OSDI'22] and BypassD [ASPLOS'24]

if [ $1 == "disable" ]; then
    echo "Disabling SMT and Turbo Boost"
    ...
    echo "Please reboot to reset all CPU configurations"
fi
